  ...
  (
    ...
    const colors = React.useMemo(() => {
      ...
      const colorsVars = [
        ...
        "[--inactive-border-color:hsl(var(--nextui-default-500))]",
        "[--inactive-color:hsl(var(--nextui-default-500))]",
      ];
    ...
    return (
      <nav aria-label="Progress" className="w-fit">
            ...
            return (
              ...
              >
                ...
                >
                  <div className="h-ful relative flex items-center">
                    ...
                    {stepIdx < steps.length - 1 && !hideProgressBars && (
                      ...
                      >
                        <div
                          className={cn(
                            "relative h-0.5 w-full bg-default-500 transition-colors duration-300",
                  ...
                  <div className="w-[120px] flex-1 px-2 text-center" />
                </button>
              </li>
            );
          })}
